...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/extempore-print-devices.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/extempore-start.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/text-editor-start.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/scheme-code-input.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/scheme-eval.png" alt=""></a> 
#+end_html
...
which is an xtlang global variable of [[file:2012-08-09-xtlang-type-reference.org][type]] =SAMPLE= (=float= by
default). If you evaluate this with =C-M-x= (or whatever the command
is in your editor) then what happens is

#+begin_html
<a href=""><img src="/img/interacting-with-compiler/xtlang-eval-1.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/xtlang-eval-2.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/xtlang-eval-3.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/xtlang-eval-4.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/doughnut-area.png" width="250px" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/xtlang-eval-5.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/extempore-restart.png" width="300px" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/xtlang-compile-error.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/xtlang-eval-6.png" alt=""></a> 
#+end_html
...
#+begin_html
<a href=""><img src="/img/interacting-with-compiler/xtlang-eval-7.png" alt=""></a> 
#+end_html
