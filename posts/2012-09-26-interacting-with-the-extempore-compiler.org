...
There are lots of places to go now, you can keep reading through [[file:~/Documents/biott/extempore-docs/index.org][the
docs]], or start poking around the =examples/= subdirectory in the
Extempore sources.
