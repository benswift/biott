#+PROPERTY: header-args:extempore :tangle /tmp/2012-11-26-reading-writing-audio-files-in-extempore.xtm
#+begin_html
---
...
Sounds saturated and messy---great.[fn:SAMPLE] Now, we want to write the
...
[fn:SAMPLE] We had to wrap the =0.0= value in a =convert= call to get the
types right, as discussed in another [[file:2013-11-15-changing-from-doubles-to-floats-in-audio_dsp.org][post]].
