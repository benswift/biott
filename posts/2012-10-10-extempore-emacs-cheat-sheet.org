#+PROPERTY: header-args:extempore :tangle /tmp/2012-10-10-extempore-emacs-cheat-sheet.xtm
#+begin_html
---
...
5. connect to the running Extempore process: =C-x C-j= (this needs to be
