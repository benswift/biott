...
they are running. As a simple example: place your cursor
inside the expression below and press the eval button which is located
at the top-right of the editor window (copy the (now) expression into
your Extempore editor window and place the cursor inside the
