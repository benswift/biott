...
kernels for our hammond organ instrument.  As we've just seen in the
previous section once we have those, =define-instrument= and
=play-note= allow us to play the organ like a soft synth, which is the
goal we've been pursuing since the beginning.
