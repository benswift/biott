...
By having multiple tonewheels...
In a Hammond organ, the frequencies of the different tonewheels are
related to the 

The key tone-shaping control in a Hammond organ are its drawbars.
Each drawbar affects the amplitude of one of the sinusoids.

# #+begin_html
# <a href=""><img src="images/pointer-tut-1.png" alt="Image from
# Wikimedia Commons"></a>
# #+end_html

[fn:quirks]Any commercial
