...
(which is adapted from [[http://impromptu.moso.com.au/tutorials/making_music/The%2520Basics.html][some tutorials]] Andrew originally wrote for
...
coincidence---todo this post shows you how to do exactly that!  It'll
...
that asks ='get-beat= to quantize to a =4.0= (i.e. four beats) instead
of the default =1.0=. I'm going to play cowbell and triangle with a
slight =0.25= offset.
