...
=libs/core/instruments.xtm=) then you can just start at this post. If
you'd like to have a [[file:2012-10-16-a-really-simple-instrument.org][brief]] or [[file:2012-09-28-making-an-instrument.org][in-depth]] look at how the instrument
infrastructure works (including how to write your own in xtlang) then
you'll have a better (but by no means necessary) understanding of
what's going on 'under the hood' in this post.

The note-level approach to music generation will be very familiar to
Impromptu users.  This post is actually a modified version of [[http://impromptu.moso.com.au/tutorials/bing.html][a
tutorial]] that Andrew wrote for Impromptu.
...
The second part of this tutorial will give you a much better idea of
...
a relatively small amount of code.  Stay tuned!
