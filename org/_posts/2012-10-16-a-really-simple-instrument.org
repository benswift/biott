...
soft synth. [[file:~/Documents/biott/org/_posts/2012-09-28-making-an-instrument.org][This post]] goes into a lot more detail about how
...
All the instrument code is just regular [[file:~/Documents/biott/org/_posts/2012-08-09-xtlang-type-reference.org][xtlang]], and can be found in
...
In an [[file:~/Documents/biott/org/_posts/2012-10-03-xtlang-type-diagrams.org][xtlang type diagram]]:
...
(just edit the code and [[file:~/Documents/biott/org/_posts/2012-09-26-interacting-with-the-extempore-compiler.org][re-evaluate it]]).
...
Extempore's instrument infrastructure, then you can [[file:~/Documents/biott/org/_posts/2012-09-28-making-an-instrument.org][go and build your
own tonewheel organ]].

[fn:csuffix] By [[file:~/Documents/biott/org/_posts/2012-10-15-xtlang-naming-conventions.org][convention]], xtlang closures which /return/ closures
have a =_c= suffix.
